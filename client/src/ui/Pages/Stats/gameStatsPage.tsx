...
export const StatsPage: React.FC<StatsPageProps> = ({ setMenuState }) => {
    ...
    return (
        <ClickWrapper className="game-page-container">
            ...
            <ClickWrapper style={{ display: "flex", flexDirection: "row", justifyContent:"center", gap: "3%", position: "relative", width: "100%", height: "10%" }}>
                ...
                <div onClick={() => setStatsState(StatsState.TABLE)} style={{ opacity: statsState !== StatsState.TABLE ? 0.5 : 1, display: "flex", justifyContent: "flex-end", flex: "1" }}>
                    <div className="global-button-style invert-colors " style={{ textAlign: "center", backgroundColor: "#2C2C2C", display: "flex", justifyContent: "center", alignItems: "center", padding: "2px 20px",  boxSizing: "border-box", height: "fit-content", fontFamily: "Zelda", fontWeight: "100" }}><h2 className="test-h2 no-margin"> TABLE OF DATA</h2></div>
                </div>

                <div onClick={() => setStatsState(StatsState.SPECIFIC)} style={{ opacity: statsState !== StatsState.SPECIFIC ? 0.5 : 1, display: "flex", justifyContent: "center", width:"fit-content", flex: "1" }}>
                ...
                <div onClick={() => setStatsState(StatsState.OVERALL)} style={{ opacity: statsState !== StatsState.OVERALL ? 0.5 : 1, display: "flex", justifyContent: "flex-start", flex: "1" }}>
                    <div className="global-button-style invert-colors " style={{ textAlign: "center", backgroundColor: "#2C2C2C", display: "flex", justifyContent: "center", alignItems: "center", padding: "2px 20px", boxSizing: "border-box", height: "fit-content", fontFamily: "Zelda", fontWeight: "100" }}> <h2 className="test-h2 no-margin">OVERALL GAME DATA </h2></div>
                </div>
