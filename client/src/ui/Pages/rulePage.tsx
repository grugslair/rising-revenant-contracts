    ...
    return (
        <div className="game-page-container">
            ...
            <ClickWrapper style={{ width: "100%", height: "70%", position: "relative", display: "flex", justifyContent: "center", alignItems: "center" }}>
                <div style={{ width: "80%", height: "100%", color:"white", fontFamily:"OL", }}>

                    {rulesState === RulesState.PREP && (<>
                        <h2 style={{marginBottom:"0px"}}>Summoning the Revenants:</h2>
                        <h3 style={{marginTop:"0px"}}> Players begin by invoking Revenants, powerful entities, through a mystical expenditure of $LORDS. Each successful summoning not only brings forth a Revenant but also establishes an Outpost around the game map.</h3>

                        <h2 style={{marginBottom:"0px"}}>Building Outposts:</h2>
                        ...
                        <h2 style={{marginBottom:"0px"}}>Fortifying Outposts:</h2>
                        ...
                        <h2 style={{marginBottom:"0px"}}>The Anticipation Screen:</h2>
                        <h3 style={{marginTop:"0px"}}>Post-preparation, players enter a phase of strategic anticipation. Here, the summoning of new Revenants and bolstering of Outposts continues, setting the stage for the impending Main Phase.</h3>
                    </>) }
