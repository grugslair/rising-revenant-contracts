...
use risingrevenant::components::{
    game::{Position}, reinforcement::{ReinforcementType}, outpost::{OutpostEventStatus}
};
...
mod outpost_actions {
    ...
    use risingrevenant::{
        components::{
            outpost::{OutpostTrait, OutpostEventStatus}, game::{Position}, player::{PlayerInfo},
            reinforcement::{ReinforcementType},
        },
        systems::{
            game::{GameAction, GameActionTrait}, player::{PlayerActionsTrait},
            payment::{PaymentSystemTrait}, outpost::{OutpostActionsTrait},
        }
    };
